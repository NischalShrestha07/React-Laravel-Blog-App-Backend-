                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                        <a href="login.html" class="link-secondary text-decoration-none">Click here
                                            to
                                            login</a>
                                    </div>
                                </div>
...
<body class="bg-light">
    <div class="container-fluid shadow-lg header">
        <div class="container">
            <div class="d-flex justify-content-between">
                <h1 class="text-center"><a href="index.html" class="h3 text-white text-decoration-none">React & Laravel
                        Blog App</a></h1>
                <div class="d-flex align-items-center navigation">
                    <a href="login.html" class="text-white">Login</a>
                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="#!">
                                <div class="row gy-3 overflow-hidden">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control   @error('name')   @enderror" name="name" id="name"
                                                placeholder="Name">
...
<p class="invalid-feedback">{{$message}}</p>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <hr class="mt-5 mb-4 border-secondary-subtle">
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                        <a href="login.html" class="link-secondary text-decoration-none">Click here to
                                            login</a>
                                    </div>
                                </div>
                            </div>
